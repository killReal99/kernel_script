...
ln -s /boot/initrd.img-5.10.187-rt91 /boot/initrd.img
ln -s /boot/config-5.10.187-rt91 /boot/config
ln -s /boot/System.map-5.10.187-rt91 /boot/System.map
ln -s /boot/vmlinuz-5.10.187-rt91 /boot/vmlinuz
